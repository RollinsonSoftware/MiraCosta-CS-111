...
public class GroupProject2_2
{
	...
	int num2, asc1, asc2, asc3, asc4, asc5;
	...
	num1 = JOptionPane.showInputDialog("Enter a number (33-126)");  
	...
	System.out.printf("---------------------------%n");
	System.out.println("The number you entered was " + num2 + ", in ASCII code that would be: " + asc6);
	}
}

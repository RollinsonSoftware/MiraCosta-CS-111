...
public class TemperatureTester
{
	public static void main(String[] args)
	{
		...
		System.out.println( "Temp #1: " + temp1 );	//just to show explicit call works the same
		...
		System.out.println( "Temp #1 same: " + temp1.toString() );
		System.out.println( "Temp #2 same: " + temp2.toString() );
		System.out.println( "Temp #3 same: " + temp3.toString() );
		System.out.println( "Temp #4 same: " + temp4.toString() );
		System.out.println( "Temp #5 same: " + temp5.toString() );
